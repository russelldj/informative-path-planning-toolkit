...
class IppEnv(gym.Env):
    def __init__(self, info_dict):
        ...
        if self.action_space_discretization is None:
            ...
            self.grid_size = np.array(self.world_size) / self.action_space_discretization
    ...
    def reset(self):
        ...
        self.gp = GridWorldModel(world_size=self.world_size, grid_cell_size=self.grid_size)
